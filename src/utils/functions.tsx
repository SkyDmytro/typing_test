...
const getCorrectnIncorrectCharacters =(inputText:string, correctText:string)=>{
  const correctCharacters = inputText.split("").filter((char, idx) => char === correctText.charAt(idx)).length;
...
export {getAmountOfWords, getWordsPerMinute,getAccuracy, getCorrectnIncorrectCharacters,getStyledWords}
